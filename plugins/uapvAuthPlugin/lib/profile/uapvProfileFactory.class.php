...
class uapvProfileFactory {
   ...
   * suivantes.
   *
   * @return uapvBasicProfile ou null si le profil n'est pas trouvé
   */
  public static function find ($id)
  {
    ...
    // Si le profil ne contient aucune donnée c'est qu'il n'a pas été trouvé,
    // on renvoi alors null
    if (count ($profile->getNames ()) === 0)
      return null;
