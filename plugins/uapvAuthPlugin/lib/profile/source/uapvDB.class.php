...
class uapvDB
{
  ...
  public function __construct ($conf = null)
  {
    if (! is_array ($conf))
    {
      ...
      $conf['user_tab']     = sfConfig::has('app_bdd_info_user_table_name') ? sfConfig::get('app_bdd_info_user_table_name') : 'user' ;
      $conf['user_login']   = sfConfig::has('app_bdd_info_user_login_field') ? sfConfig::get('app_bdd_info_user_login_field') : 'login' ;
      $conf['user_pass']    = sfConfig::has('app_bdd_info_user_pass_field') ? sfConfig::get('app_bdd_info_user_pass_field') : 'pass' ;
      $conf['pass_crypt']   = sfConfig::has('app_bdd_info_user_pass_encrypt') ? sfConfig::get('app_bdd_info_user_pass_encrypt') : 'md5' ;
