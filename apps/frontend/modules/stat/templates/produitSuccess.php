<script type="text/javascript" language="javascript">
  ...
  {
    var date = $("#date").val();
    var id = $("#listeProducts").val();
    $("#conteneur").html("");
    ajaxDateForOneProduct(date,id,'<?php echo url_for("stat/ajaxOneProduct")?>');
  });
  ...
  $("#mois").change(function()
  {
    ...
    var id = $("#listeProducts").val();
    $("#conteneur").html("");
    ajaxMois(mois,id,'<?php echo url_for("stat/ajaxMois")?>');
  });
  ...
  $("#laps").change(function()
  {
    ...
    else
    {
      $("#choixAnnee").show();
      var annee = $("#annee").val();
      ajaxAnnee(annee,id,'<?php echo url_for("stat/ajaxAnnee")?>');
    }
  });
 })
</script>
